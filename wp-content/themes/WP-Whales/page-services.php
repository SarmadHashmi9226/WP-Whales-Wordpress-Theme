  ...
  <div class="col-5 col-md-5">
    <div class="container ">
      ...
      <p class="cover-text">Bringing something new to life can be challenging. But with WP Whale's MVP Development Services. 
        You can make your dream a reality with no problems. Our unique strategy promises to be a game changer for your business.
      </p>
      </div>
...
<!-- Sidebar-->
 <div class="d-flex mt-5">
  <div class="col-md-3">
 <aside class="sidebar">
  <div class="sidebar-content  text-decoration-none mb-2">
    <div class="sidebar-content border-left d-flex mb-2 ">
      <a class="services-nav" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample" id="collapseTrigger">
     How it works?
   </a>
   ...
   <ul class="list-unstyled nav-collapse">
     <li class="mb-2 fixing-text">Fixing your Purpose</li>
     <li class="mb-2">Rapid Prototyping</li>
     <li class="mb-2">Agile Design</li>
     <li class="mb-2">Analysis & Improvements</li>
     <li class="mb-2">Launch with Confidence</li>
   </ul>
 </div>
  </div>
  <div class="sidebar-content mb-2">
     <a class="client-testimonial-2"  href="#" role="button">
    Why Best Choice for MVP?
  </a>
</div>
<div class="sidebar-content mb-2">
  <a class="client-testimonial-2"  href="#" role="button">
...
<div class="sidebar-content mb-2">
  <a class="client-testimonial-2"  href="#" role="button">
    Tailored Solution for Startups
  </a>
</div>
<div class="sidebar-content mb-2">
  <a class="client-testimonial-2"  href="#" role="button">
    Key Benefits of Our MVP Services
  </a>
</div>
<div class="sidebar-content mb-2">
  <a class="client-testimonial-2"  href="#" role="button">
    The WP Whales Advantage
  </a>
</div>
<div class="sidebar-content mb-2">
  <a class="client-testimonial-2"  href="#" role="button">
...
<!-- MAin Content-->
 <div class="container-fluid ">
  <div class="col-md-10">
  <h2 class="overview-project">How it works?</h2>
    <p class="overview-text">We believe that every great project starts with a well designed MVP. Our MVP development method combines creativity and technological skills to guarantee that your product has a significant impact.</p>
    <div class="container d-flex mt-5 ">
      ...
      <div class="col-8">
        <div class="d-flex justify-content-between ">
          ...
          <div class="goal ms-2">
            <div class="d-flex justify-content-between">
            <p class="sub-title-overview">Finding Your Purpose</p>  
            <i class="fa fa-chevron-up mt-3 service-arrow-up" ></i>
          </div>
            <p class="overview-text">First we begin with an understanding of your concept. We will evaluate your goals, the primary issue that your solution will solve and your intended customer through discussions. This enables us to identify what is essential for your MVP while reducing unnecessary complications.
            </p>
          </div>
        </div>
        <div class="d-flex align-items-center justify-content-between mt-4">
          <div class="d-flex align-items-center gap-2">
            ...
            <span class="sub-title-overview">Rapid Prototyping</span>
          </div>
          <i class="fa fa-chevron-down mt-3 service-arrow-up" ></i>
        </div>
        <div class="d-flex align-items-center justify-content-between mt-4">
          <div class="d-flex align-items-center gap-2">
            <div class="image me-3 mt-1">
            ...
            <span class="sub-title-overview">Agile Design</span>
          </div>
          <i class="fa fa-chevron-down mt-3 service-arrow-up" ></i>
        </div>
        <div class="d-flex align-items-center justify-content-between mt-4">
          <div class="d-flex align-items-center gap-2">
            ...
            <span class="sub-title-overview">Analysis And Improvements</span>
          </div>
          <i class="fa fa-chevron-down mt-3 service-arrow-up" ></i>
        </div>
        <div class="d-flex align-items-center justify-content-between mt-4">
          <div class="d-flex align-items-center gap-2">
            ...
            <span class="sub-title-overview">Launch with Confidence</span>
          </div>
          <i class="fa fa-chevron-down mt-3 service-arrow-up" ></i>
        </div>
...
<!-- Why We Best?-->
  ...
  <div class="col-10">
    ...
    <p class="overview-text">At WP Whales we have proven ourselves as a top MVP development company by continuously offering significant results. 
      ...
      <div class="container-fluid black mt-5">
          <div class="row">
           <img class="bg-img-2" src="<?php echo get_template_directory_uri(); ?>/src/images/Black.svg" alt="img">
 ...
 <section class="container-fluid sec">
  ...
  <div class="container-fluid black mt-5">
    <div class="row">
      <img class="bg-img" src="<?php echo get_template_directory_uri(); ?>/src/images/Black.svg" alt="img">
...
<div class="col-md-10">
  <h2 class="overview-project">The Tech Stack We Use for MVP Development</h2>
    <p class="overview-text">The right tools are essential for building a high quality MVP. WP Whales employs a cutting edge tech stack to ensure every product is efficient, scalable and future proof.
    </p>
    <div class="container mt-5">
      <div class="d-flex align-items-center mb-4">
        <img src="<?php echo get_template_directory_uri(); ?>/src/images/programming.svg" alt="icon" class="me-2" style="width: 24px;">
        <h5 class="mb-0 fw-bold">Programming Languages</h5>
      </div>
  
      <div class="row g-3">
        <div class="col-6 col-md-3 col-lg-2">
          <div class="p-3 programming-card text-center rounded-3 shadow-sm">
            <img src="<?php echo get_template_directory_uri(); ?>/src/images/javascript.svg" alt="JavaScript" style="width: 40px;">
            <p class="mt-2 mb-0 programming-subtitle">JavaScript</p>
          </div>
        </div>
  
        <div class="col-6 col-md-3 col-lg-2">
          <div class="p-3 programming-card text-center rounded-3 shadow-sm">
            <img src="<?php echo get_template_directory_uri(); ?>/src/images/python.svg" alt="Python" style="width: 40px;">
            <p class="mt-2 mb-0 programming-subtitle">Python</p>
          </div>
        </div>
  
        <div class="col-6 col-md-3 col-lg-2">
          <div class="p-3 programming-card text-center rounded-3 shadow-sm">
            <img src="<?php echo get_template_directory_uri(); ?>/src/images/ruby.svg" alt="Ruby" style="width: 40px;">
            <p class="mt-2 mb-0 programming-subtitle">Ruby</p>
          </div>
        </div>
      </div>
      <!-- 2nd -->
      <div class="d-flex align-items-center mb-4 mt-5">
        <img src="<?php echo get_template_directory_uri(); ?>/src/images/framework.svg" alt="icon" class="me-2" style="width: 24px;">
        <h5 class="mb-0 fw-bold">Frameworks</h5>
      </div>

      <div class="row g-3 ">
        <div class="col-6 col-md-3 col-lg-2">
          <div class="p-3  programming-card text-center rounded-3 shadow-sm">
            <img src="<?php echo get_template_directory_uri(); ?>/src/images/react.svg" alt="react" style="width: 40px;">
            <p class="mt-2 mb-0 programming-subtitle">React</p>
          </div>
        </div>
  
        <div class="col-6 col-md-3 col-lg-2">
          <div class="p-3 programming-card text-center rounded-3 shadow-sm">
            <img src="<?php echo get_template_directory_uri(); ?>/src/images/angular.svg" alt="angular" style="width: 40px;">
            <p class="mt-2 mb-0 programming-subtitle">Angular</p>
          </div>
        </div>
  
        <div class="col-6 col-md-3 col-lg-2">
          <div class="p-3 programming-card text-center rounded-3 shadow-sm">
            <img src="<?php echo get_template_directory_uri(); ?>/src/images/node.svg" alt="node" style="width: 40px;">
            <p class="mt-2 mb-0 programming-subtitle">Node.js</p>
          </div>
        </div>

        <div class="col-6 col-md-3 col-lg-2">
          <div class="p-3 programming-card text-center rounded-3 shadow-sm">
            <img src="<?php echo get_template_directory_uri(); ?>/src/images/django.svg" alt="django" style="width: 40px;">
            <p class="mt-2 mb-0 programming-subtitle">Django</p>
          </div>
        </div>
      </div>
<!-- 3rd-->
<div class="d-flex align-items-center mb-4 mt-5">
  <img src="<?php echo get_template_directory_uri(); ?>/src/images/database.svg" alt="icon" class="me-2" style="width: 24px;">
  <h5 class="mb-0 fw-bold">Databases</h5>
</div>

<div class="row g-3 ">
  <div class="col-6 col-md-3 col-lg-2">
    <div class="p-3  programming-card text-center rounded-3 shadow-sm">
      <img src="<?php echo get_template_directory_uri(); ?>/src/images/sql.svg" alt="sql" style="width: 40px;">
      <p class="mt-2 mb-0 programming-subtitle">MySQL</p>
    </div>
  </div>

  <div class="col-6 col-md-3 col-lg-2">
    <div class="p-3 programming-card text-center rounded-3 shadow-sm">
      <img src="<?php echo get_template_directory_uri(); ?>/src/images/p-sql.svg" alt="PostgreSQL" style="width: 40px;">
      <p class="mt-2 mb-0 programming-subtitle">PostgreSQL</p>
    </div>
  </div>

  <div class="col-6 col-md-3 col-lg-2">
    <div class="p-3 programming-card text-center rounded-3 shadow-sm">
      <img src="<?php echo get_template_directory_uri(); ?>/src/images/mongo.svg" alt="mongo" style="width: 40px;">
      <p class="mt-2 mb-0 programming-subtitle">MongoDB</p>
    </div>
  </div>
</div>
...
<!-- 4th -->
<div class="d-flex align-items-center mb-4 mt-5">
  <img src="<?php echo get_template_directory_uri(); ?>/src/images/cloud.svg" alt="icon" class="me-2" style="width: 24px;">
  <h5 class="mb-0 fw-bold">Cloud Platforms</h5>
</div>

<div class="row g-3 ">
  <div class="col-6 col-md-3 col-lg-2">
    <div class="p-3  programming-card text-center rounded-3 shadow-sm">
      <img src="<?php echo get_template_directory_uri(); ?>/src/images/aws.svg" alt="sql" style="width: 40px;">
      <p class="mt-2 mb-0 programming-subtitle">AWS</p>
    </div>
  </div>

  <div class="col-6 col-md-3 col-lg-2">
    <div class="p-3 programming-card text-center rounded-3 shadow-sm">
      <img src="<?php echo get_template_directory_uri(); ?>/src/images/azure.svg" alt="PostgreSQL" style="width: 40px;">
      <p class="mt-2 mb-0 programming-subtitle">Microsoft Azure</p>
    </div>
  </div>

  <div class="col-6 col-md-3 col-lg-2">
    <div class="p-3 programming-card text-center rounded-3 shadow-sm">
      <img src="<?php echo get_template_directory_uri(); ?>/src/images/google.svg" alt="mongo" style="width: 40px;">
      <p class="mt-2 mb-0 programming-subtitle">Google Cloud</p>
    </div>
  </div>
</div>
